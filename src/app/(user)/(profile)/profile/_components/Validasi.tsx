...
export const ValidatePage: FC<UploadPageProps> = ({ userData, file }) => {
  ...
  const handleFile = (id: string, link: string) => {
    setOpenFile((prev) => ({
      ...prev,
      [id]: {
                  ...
                  (file) =>
                    file && (
                      ...
                      >
                        ...
                        <FormButton
                          ...
                          onClick={() => {
                            ...
                            if (
                              ...
                              handleFile(file.id, file.permisionId as string);
                            } else {
                        ...
                        <>
                          {openFile[file.id]?.isOpen && (
                            <ModalProfile
                              title={file.filename}
                              onClose={() => handleFile(file.id, "")}
                              className="h-screen"
                            >
                              <iframe
                                className="w-full h-full"
                                src={`https://drive.google.com/file/d/${
                                  openFile[file.id]?.link
                                }/preview`}
